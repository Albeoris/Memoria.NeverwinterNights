...
void main()
{
    ...
    string sString = nStrRef == 1   ? "I should keep an eye out for treasure in this area." 
                   ...
                   : nStrRef == 601  ? "Tell me how to use M_LSE!"
                   : nStrRef == 602  ? "All the features of M_LSE were automatically installed. No need to take any further action, except if you want to toggle or customize some of the features, which is covered by this tutorial."
                   : nStrRef == 603  ? "To interact with M_LSE, find and use the \"Player Tool 9\" under \"Special Abilities\" in your right click menu. You will then be required to choose a target, which defines what kind of interaction to take. Do not select anything right now, as this would close the tutorial!"
                   : nStrRef == 604  ? "What happens when I select my character?"
                   : nStrRef == 605  ? "What happens when I select a corpse?"
                   : nStrRef == 606  ? "I know how to use M_LSE now. Close the tutorial."
