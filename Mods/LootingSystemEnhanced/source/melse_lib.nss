...
void MELSE_InjectEventScripts(object oModule)
{
    ...
    if (!ESI_IsRegistered(oModule, MELSE_INJECT_KEY_MODULE_ACQUIRED_ITEM, EVENT_SCRIPT_MODULE_ON_ACQUIRE_ITEM, MELSE_SCRIPT_EVENT_MODULE_ACQUIRED_ITEM, ESI_INJECTION_PLACEMENT_LAST) && !ESI_InjectToObject(oModule, MELSE_INJECT_KEY_MODULE_ACQUIRED_ITEM, EVENT_SCRIPT_MODULE_ON_ACQUIRE_ITEM, MELSE_SCRIPT_EVENT_MODULE_ACQUIRED_ITEM, ESI_INJECTION_PLACEMENT_LAST)) bRegistered = FALSE;
    object oArea = GetFirstArea();
    while (GetIsObjectValid(oArea))
    {
        if (!ESI_IsRegistered(oArea, MELSE_INJECT_KEY_AREA_ENTER, EVENT_SCRIPT_AREA_ON_ENTER, MELSE_SCRIPT_EVENT_AREA_ENTER, ESI_INJECTION_PLACEMENT_LAST) && !ESI_InjectToObject(oArea, MELSE_INJECT_KEY_AREA_ENTER, EVENT_SCRIPT_AREA_ON_ENTER, MELSE_SCRIPT_EVENT_AREA_ENTER, ESI_INJECTION_PLACEMENT_LAST)) bRegistered = FALSE;
        oArea = GetNextArea();
    }
...
void MELSE_InjectAreaObjects(object oArea)
{
    ...
    while (GetIsObjectValid(oObject))
    {
        ...
        {
            if (!ESI_IsRegistered(oObject, MELSE_INJECT_KEY_CREATURE_DEATH, EVENT_SCRIPT_CREATURE_ON_DEATH, MELSE_SCRIPT_EVENT_CREATURE_DEATH, ESI_INJECTION_PLACEMENT_LAST) && !ESI_InjectToObject(oObject, MELSE_INJECT_KEY_CREATURE_DEATH, EVENT_SCRIPT_CREATURE_ON_DEATH, MELSE_SCRIPT_EVENT_CREATURE_DEATH, ESI_INJECTION_PLACEMENT_LAST)) bRegistered = FALSE;
        }
        else if (nObjectType == OBJECT_TYPE_PLACEABLE)
        {
            if (!ESI_IsRegistered(oObject, MELSE_INJECT_KEY_PLACEABLE_OPEN, EVENT_SCRIPT_PLACEABLE_ON_OPEN, MELSE_SCRIPT_EVENT_PLACEABLE_OPEN, ESI_INJECTION_PLACEMENT_LAST) && !ESI_InjectToObject(oObject, MELSE_INJECT_KEY_PLACEABLE_OPEN, EVENT_SCRIPT_PLACEABLE_ON_OPEN, MELSE_SCRIPT_EVENT_PLACEABLE_OPEN, ESI_INJECTION_PLACEMENT_LAST)) bRegistered = FALSE;
            if (!ESI_IsRegistered(oObject, MELSE_INJECT_KEY_PLACEABLE_CLOSE, EVENT_SCRIPT_PLACEABLE_ON_CLOSED, MELSE_SCRIPT_EVENT_PLACEABLE_CLOSE, ESI_INJECTION_PLACEMENT_FIRST) && !ESI_InjectToObject(oObject, MELSE_INJECT_KEY_PLACEABLE_CLOSE, EVENT_SCRIPT_PLACEABLE_ON_CLOSED, MELSE_SCRIPT_EVENT_PLACEABLE_CLOSE, ESI_INJECTION_PLACEMENT_FIRST)) bRegistered = FALSE;
            if (!ESI_IsRegistered(oObject, MELSE_INJECT_KEY_PLACEABLE_UNLOCK, EVENT_SCRIPT_PLACEABLE_ON_UNLOCK, MELSE_SCRIPT_EVENT_PLACEABLE_UNLOCK, ESI_INJECTION_PLACEMENT_LAST) && !ESI_InjectToObject(oObject, MELSE_INJECT_KEY_PLACEABLE_UNLOCK, EVENT_SCRIPT_PLACEABLE_ON_UNLOCK, MELSE_SCRIPT_EVENT_PLACEABLE_UNLOCK, ESI_INJECTION_PLACEMENT_LAST)) bRegistered = FALSE;
        }
        oObject = GetNextObjectInArea(oArea);
    }
...
{
    if (!ESI_IsRegistered(oCreature, MELSE_INJECT_KEY_CREATURE_DEATH, EVENT_SCRIPT_CREATURE_ON_DEATH, MELSE_SCRIPT_EVENT_CREATURE_DEATH, ESI_INJECTION_PLACEMENT_LAST)) ESI_InjectToObject(oCreature, MELSE_INJECT_KEY_CREATURE_DEATH, EVENT_SCRIPT_CREATURE_ON_DEATH, MELSE_SCRIPT_EVENT_CREATURE_DEATH, ESI_INJECTION_PLACEMENT_LAST);
...
void MELSE_InitializeCorpse(object oCorpse)
{
    ...
    {
        if (!ESI_IsRegistered(oBodyBag, MELSE_INJECT_KEY_PLACEABLE_CLOSE, EVENT_SCRIPT_PLACEABLE_ON_CLOSED, MELSE_SCRIPT_EVENT_PLACEABLE_CLOSE, ESI_INJECTION_PLACEMENT_FIRST)) ESI_InjectToObject(oBodyBag, MELSE_INJECT_KEY_PLACEABLE_CLOSE, EVENT_SCRIPT_PLACEABLE_ON_CLOSED, MELSE_SCRIPT_EVENT_PLACEABLE_CLOSE, ESI_INJECTION_PLACEMENT_FIRST);
        nNext++;
