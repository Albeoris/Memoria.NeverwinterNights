...
void METACT_InstallHook()
{
    ...
    if (!ESI_IsRegistered(oModule, METACT_ESI_KEY_GUI, EVENT_SCRIPT_MODULE_ON_PLAYER_GUIEVENT, "metact_guievt", ESI_INJECTION_PLACEMENT_FIRST)) ESI_InjectToObject(oModule, METACT_ESI_KEY_GUI, EVENT_SCRIPT_MODULE_ON_PLAYER_GUIEVENT, "metact_guievt", ESI_INJECTION_PLACEMENT_FIRST);
    if (!ESI_IsRegistered(oModule, METACT_ESI_KEY_TARGET, EVENT_SCRIPT_MODULE_ON_PLAYER_TARGET, "metact_target", ESI_INJECTION_PLACEMENT_FIRST)) ESI_InjectToObject(oModule, METACT_ESI_KEY_TARGET, EVENT_SCRIPT_MODULE_ON_PLAYER_TARGET, "metact_target", ESI_INJECTION_PLACEMENT_FIRST);
}
